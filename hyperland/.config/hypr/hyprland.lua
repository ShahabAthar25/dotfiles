...
local menu        = "rofi -show drun -theme /home/shahab/.config/rofi/app-launcher.rasi"
...
hl.on("hyprland.start", function()
  hl.exec_cmd("swaync")
  hl.exec_cmd(
    "mpvpaper -o 'no-audio loop-playlist speed=0.5 hwdec=auto-safe profile=fast' '*' /home/shahab/Videos/Wallpapers/sword_opt.mp4")
  hl.exec_cmd("waybar")
end)
...
hl.animation({ leaf = "workspacesIn", enabled = true, speed = 1.6, bezier = "almostLinear", style = "slidefade 30%" })
hl.animation({ leaf = "workspacesOut", enabled = true, speed = 1.94, bezier = "almostLinear", style = "slidefade 30%" })
...
-- Lockscreen
hl.bind(mainMod .. " + ALT + l", hl.dsp.exec_cmd("~/.local/share/quickshell-lockscreen/lock.sh"))
